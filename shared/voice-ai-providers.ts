...
export const TTS_PROVIDERS: Record<string, VoiceAIProviderMetadata> = {
  ...
  'fish-audio-tts': {
    ...
    category: 'tts',
    subcategories: ['tts'],
    description: 'Multilingual text-to-speech with custom voice models and low-latency streaming options',
    capabilities: {
      streaming: true,
      realtime: true,
      customVoices: true,
    ...
    supportedLanguages: ['en', 'zh', 'ja', 'ko', 'es', 'fr', 'de', 'it', 'pt', 'hi'],
    pricing: {
      model: 'Usage-based',
      details: 'Developer free tier available with s2.1-pro-free; paid production models available',
    },
    credentials: [
      {
        key: 'apiKey',
        ...
        description: 'Your Fish Audio API token',
      },
    ],
    integration: {
      apiVersion: 'v1',
      baseUrl: 'https://api.fish.audio',
      testEndpoint: '/model?page_size=1&page_number=1&sort_by=score',
    },
    status: 'production',
    tier: 'professional',
...
export const ALL_IN_ONE_PROVIDERS: Record<string, VoiceAIProviderMetadata> = {
  ...
  'livekit': {
    id: 'livekit',
    name: 'livekit',
    displayName: 'LiveKit (Dashboard)',
    category: 'all-in-one',
    subcategories: [],
    description: 'Connect your LiveKit account to view rooms, participants, and usage analytics. Dashboard integration only - voice calling handled by other providers.',
    capabilities: {
      streaming: false,
      realtime: false,
      customModels: false,
    ...
    credentials: [
      {
        ...
        required: true,
        placeholder: 'API...',
        description: 'Your LiveKit Cloud API key for dashboard access',
      },
      {
        key: 'apiSecret',
        label: 'API Secret',
        ...
        description: 'Your LiveKit Cloud API secret',
      },
      {
        key: 'wsUrl',
        label: 'Server URL',
        ...
        description: 'Your LiveKit server URL for API access',
      },
    ],
    integration: {
      apiVersion: 'v1',
